...
/// Builds the raw reqwest client used by embedding hosts that own their transport layer.
pub fn build_reqwest_client() -> reqwest::Client {
    ...
    codex_http_client::build_reqwest_client_with_custom_ca(builder).unwrap_or_else(|error| {
