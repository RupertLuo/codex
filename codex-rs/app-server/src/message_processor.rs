...
pub(crate) struct MessageProcessor {
    ...
    rpc_registry: Arc<crate::rpc_extension::AppServerRpcRegistry>,
}
...
impl crate::rpc_extension::AppServerNativeTurnGateway for MessageProcessorNativeTurnGateway {
    fn start_turn<'a>(
        &'a self,
        params: TurnStartParams,
        plugin_selection: Option<crate::rpc_extension::AppServerNativePluginSelection>,
    ) -> crate::rpc_extension::AppServerNativeTurnFuture<'a> {
...
impl crate::rpc_extension::AppServerNativePluginGateway for MessageProcessorNativePluginGateway {
    fn list_plugins<'a>(
        &'a self,
        params: PluginListParams,
    ) -> crate::rpc_extension::AppServerNativePluginFuture<'a> {
        Box::pin(async move {
            self.processor
                .plugin_processor
    ...
    fn loaded_plugin_roots<'a>(
        &'a self,
    ) -> crate::rpc_extension::AppServerNativePluginRootsFuture<'a> {
...
pub(crate) struct MessageProcessorArgs {
    ...
    pub(crate) thread_manager_runtime_options: codex_core::ThreadManagerRuntimeOptions,
    pub(crate) rpc_registry: Arc<crate::rpc_extension::AppServerRpcRegistry>,
}
...
impl MessageProcessor {
    ...
    pub(crate) fn new(args: MessageProcessorArgs) -> Self {
        ...
        let thread_manager = Arc::new_cyclic(|thread_manager| {
            ...
            let manager = ThreadManager::new_with_runtime_options(
                config.as_ref(),
                auth_manager.clone(),
                ...
                thread_manager_runtime_options.clone(),
            );
    ...
    async fn start_extension_native_turn(
        ...
        let request = QueuedInitializedRequest::new(
            ...
            async move {
                if let Some(plugin_selection) = plugin_selection
                ...
                let result = processor
                    ...
                    .and_then(|response| match response {
                        ...
                        _ => Err(crate::error_code::internal_error(
        ...
        result_rx.await.map_err(|_| {
            crate::error_code::internal_error(
                "native turn gateway was cancelled before the request completed",
            )
        })?
    }
    ...
    pub(crate) async fn process_request(
        ...
        session: Arc<ConnectionSessionState>,
        rpc_context: crate::rpc_extension::AppServerRpcContext,
    ) {
