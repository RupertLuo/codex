...
export type Config = {model: string | null, review_model: string | null, /**
 * Model used specifically for local conversation compaction.
 */
compact_model: string | null, model_context_window: bigint | null, model_auto_compact_token_limit: bigint | null, model_auto_compact_enabled: boolean | null, model_auto_compact_token_limit_scope: AutoCompactTokenLimitScope | null, model_provider: string | null, approval_policy: AskForApproval | null, /**
