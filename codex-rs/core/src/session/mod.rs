...
pub(crate) struct SessionSpawnArgs {
    ...
    pub(crate) http_transport: Option<codex_api::HttpTransportHandle>,
    pub(crate) model_runtime_policies:
        std::collections::HashMap<String, crate::client::ModelRuntimePolicy>,
