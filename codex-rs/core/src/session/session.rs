...
impl Session {
    ...
    pub(crate) async fn new(
        ...
        environment_selections: &[TurnEnvironmentSelection],
        config: Arc<Config>,
        http_transport: Option<codex_api::HttpTransportHandle>,
        model_runtime_policies: std::collections::HashMap<
            String,
            crate::client::ModelRuntimePolicy,
        >,
        ...
        let session_result: anyhow::Result<Arc<Self>> = async {
            ...
            let services = SessionServices {
                ...
                .with_http_transport(http_transport)
                .with_model_runtime_policies(model_runtime_policies)
