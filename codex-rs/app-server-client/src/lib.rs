...
impl InProcessAppServerClient {
    ...
    pub async fn start(args: InProcessClientStartArgs) -> IoResult<Self> {
        Self::start_with_thread_manager_options(args, ThreadManagerRuntimeOptions::default()).await
    }

    /// Starts the embedded runtime with process-local thread manager overrides.
    pub async fn start_with_thread_manager_options(
        ...
        let mut handle = codex_app_server::in_process::start_with_thread_manager_options(
