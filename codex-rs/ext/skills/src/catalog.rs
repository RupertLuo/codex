...
/// A provider-owned skill package needed by another package.
///
/// This is separate from [`SkillDependencies`], which describes runtime tool
/// dependencies declared by a skill manifest.
